...
original_author="FabriccioF7"
original_name="fafa"
original_urlname="fafa"
original_description="Awesome fafa created by FabriccioF7" 
...
then
    ...
    echo "then run 'fafa' or 'python -m fafa'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'fafa' or 'python -m fafa' or 'poetry run fafa'"
fi
