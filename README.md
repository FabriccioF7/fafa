...
- 🎯 Entry points to execute your program using `python -m <fafa>` or `$ fafa` with basic CLI argument parsing.
...
---
# fafa Flask Application

Awesome fafa created by FabriccioF7
...
```bash
git clone https://github.com/FabriccioF7/fafa fafa
cd fafa
make install
```
...
```bash
fafa create-db   # run once
fafa populate-db  # run once (optional)
fafa add-user -u admin -p 1234  # ads a user
fafa run
```
